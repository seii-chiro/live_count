    ...
    return (
        <div className="w-full flex justify-center mt-4">
            <div className="w-[90%] flex gap-4">
                <div className="border border-[#E9BC49] bg-[#E9BC49]/10 flex items-center justify-between rounded-[10px] px-4 flex-[2]">
                ...
                <div className="border border-[#D8D8D8] rounded-[10px] p-4 flex-1">
